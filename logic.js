document.addEventListener('DOMContentLoaded', () => {
    ...
    const seasonImages = {
        season1: [
            { src: 'showcase/Season1/1.webp', alt: '' },
            { src: 'showcase/Season1/2.webp', alt: '' },
            { src: 'showcase/Season1/3.webp', alt: '' },
            { src: 'showcase/Season1/4.webp', alt: '' },
            { src: 'showcase/Season1/5.webp', alt: '' },
            { src: 'showcase/Season1/6.webp', alt: '' },
        ],
        season2: [
        ]
    };
    ...
    function updateScrollSpeed() {
        ...
        const pixelsPerSecond = 100; // Speed Adujster
